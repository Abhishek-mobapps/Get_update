    ...
    <div class="bg-light p-3">
        <header>
            <div class="topbar d-flex align-items-center">
                <nav class="navbar navbar-expand w-100 justify-content-end">
                        ...
                        <a class="d-flex align-items-center nav-link dropdown-toggle gap-2" href="#"
                            ...
                            <div class="user-info d-none d-md-block">
                                <p class="user-name mb-0 fw-semibold">
                                    {{ Auth::guard('admin')->user()?->name ?? 'Guest' }}</p>
                                <p class="designation mb-0 text-muted small">
                                    {{ Auth::guard('admin')->user()?->email ?? 'Guest' }}</p>
                            </div>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm rounded-3 p-2">
                            <li>
                                <a class="dropdown-item d-flex align-items-center py-2"
                                    href="{{ route('admin.user-profiles') }}">
