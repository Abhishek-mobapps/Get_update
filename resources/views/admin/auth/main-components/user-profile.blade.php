...
<div class="container">
        ...
        : asset('assets/images/avatars/default.png') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
											<div class="mt-3">
									...
									<div class="card-body">
										<div class="row mb-3">
											...
											{{-- <div class="col-sm-9 text-secondary">
												<input type="hidden" class="form-control" value="{{ Auth::guard('admin')->user()->name }}" />
											</div> --}}
											<div class="col-sm-9 text-secondary">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" class="form-control" value="{{ Auth::guard('admin')->user()->contact_number }}" />
											</div>
										</div>
										{{-- <div class="row mb-3">
											<div class="col-sm-3">
