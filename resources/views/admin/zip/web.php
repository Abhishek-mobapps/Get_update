...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::post('/users/{id}/toggle-status', [AdminUserController::class, 'toggleStatus'])->name('admin.users.toggle-status');
        ...
        // Route::post('/products/filter', [ProductController::class, 'filter'])->name('user.products.filter');
