                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 d-flex justify-content-center gap-4">
                                        <button type="button" class="tg-btn-sign"
                                            onclick="selectSubscription('monthly', this)">Subscribe monthly -
                                            $39</button>
                                        <button type="button" class="tg-btn-sign"
                                            onclick="selectSubscription('yearly', this)">Subscribe yearly -
                                            $299</button>
                                    </div>
                            ...
                            <script>
                                function selectSubscription(type, btn) {
                                    ...
                                    // Optional: show visual feedback on selected button
                                    const allButtons = document.querySelectorAll('.tg-btn-sign');
